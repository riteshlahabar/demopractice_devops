...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('fastkart-invoice/images/icon.png') }}" type="image/x-icon">
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('fastkart-invoice/css/style.css') }}">
                    ...
                    <div class="invoice-wrapper">
                        <div class="invoice-header">
                            <div class="header-image">
                                <img src="{{ asset('fastkart-invoice/images/logo.svg') }}" class="img-fluid" alt="logo">
                            </div>
                        ...
                        <div class="invoice-footer">
                            <div class="signature-box">
                                <img src="{{ asset('fastkart-invoice/images/sign.png') }}" class="img-fluid" alt="">
