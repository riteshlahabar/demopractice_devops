            ...
            <tr>
                <td>
                    ...
                    <table style="padding: 27px;" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('fastkart-email/images/order-success-poster.png') }}" alt="" style="width: 100%; height: 100%;">
                            </td>
                        </tr>
                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <img src="{{ asset('fastkart-email/images/product-4.png') }}" alt="">
                                                </td>
                                                <td
                                                    style="padding: 28px 0;border-bottom: 1px solid rgba(217, 217, 217, 0.5);">
                                            ...
                                            <tr>
                                                <td style="padding-top: 28px;">
                                                    <img src="{{ asset('fastkart-email/images/product-5.png') }}" alt="">
                                                </td>
                                                <td style="padding-top: 28px;">
                                                    <ul class="product-detail">
